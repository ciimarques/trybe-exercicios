...
function checkIntegerPositive (l1,l2,l3) {
  return  l1 > 0 && l2 > 0 && l3 > 0 && Number.isInteger(l1) && Number.isInteger(l2) && Number.isInteger(l3)
...
function checkItsATriangle (l1,l2,l3) {
  ...
  let somaLado2 = l1 + l3
  let somaLado3 = l3 + l1
  return l1 < somaLado1 && l2 < somaLado2 && l3 < somaLado3
}
         
//console.log(ccheckItsATriangle(lado1,lado2, lado3)) 
...
function infoTriangle (l1,l2,l3) {
 let positivos = checkIntegerPositive(l1, l2, l3)
 let isTriangle = checkItsATriangle(l1, l2, l3)
if(positivos && isTriangle){ 
  let triangleType = checkWitchTriangle(l1,l2,l3)
  let perimeterType = checkPerimeterTriangle(l1, l2, l3)
  return 'O triângulo é ' +  triangleType  +  ' seu perímetro vale ' +  perimeterType + 'cm'
  } else {
